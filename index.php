...
<head>
  ...
  <title> DTSanchez Construction </title>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="index.html">
            <span>
              <div class="img-box">
                <img src="images/l1w.png" class="logotop" alt="">
              </div>
            </span>
          </a>
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      From stunning decks to expertly crafted paver installations, we bring your vision to life with quality you can trust. Discover how we can transform your outdoor space today!                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Get a free Submission now
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div class="container ">
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    <h1>
                      Specializing in LandScapping and HardScapping
                    </h1>
                    <p>
                      Ready to refresh your yard? We offer all kinds of landscaping and hardscape services to help you upgrade your outdoor space.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Get a free Submission now
            ...
            <div class="container ">
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    <h1>
                      Make You're wildest project come to life!
                    </h1>
                    <p>
                      Transform your deck today with expert craftsmanship. Don’t hesitate—contact us now for top-quality service!                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Get a free Submission Now
                      </a>
  ...
  <section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <li data-filter=".burger">Pavement</li>
        <li data-filter=".pizza">Deck</li>
        <li data-filter=".pasta">Fence</li>
        <li data-filter=".fries">Garden</li>
        <li data-filter=".fries">Other</li>
        <li data-filter=".fries">Custom</li>
      </ul>
        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/paver2.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Castlebrown pavement
                  </h5>
                  <p>
                    Veniam debitis quaerat officiis quasi cupiditate quo, quisquam velit, magnam voluptatem repellendus sed eaque
                  </p>
